package me.sparker0i.lawnchair.lawnfeed
...
import me.sparker0i.lawnchair.launcherclient.LauncherClientProxyConnection
...
class ProxyImpl(val context: Context) : ILauncherClientProxy.Stub() {
    ...
    override fun init(callback: ILauncherClientProxyCallback): Int {
        allowed = "me.sparker0i.lawnchair" == callingPackage
        enforcePermission()
