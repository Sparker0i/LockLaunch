...
import me.sparker0i.lawnchair.launcherclient.ILauncherClientProxy
...
class LawnfeedClient(private val launcher: me.sparker0i.lawnchair.Launcher) : ILauncherClient {
    ...
    companion object {
        const val PROXY_PACKAGE = "me.sparker0i.lawnchair.lawnfeed"
