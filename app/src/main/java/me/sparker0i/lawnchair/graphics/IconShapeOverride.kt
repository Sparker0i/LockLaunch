package me.sparker0i.lawnchair.graphics
...
import me.sparker0i.lawnchair.preferences.blockingEdit
...
class IconShapeOverride {
    ...
    class PreferenceChangeHandler constructor(val context: Context) : OnPreferenceChangeListener {
        ...
        override fun onPreferenceChange(preference: Preference, obj: Any): Boolean {
            ...
            if (getAppliedValue(context).savedPref != str) {
                ...
                me.sparker0i.lawnchair.LauncherAppState.getInstance().iconCache.clear()
    ...
    companion object {
        ...
        fun isSupported(context: Context): Boolean {
            if (me.sparker0i.lawnchair.Utilities.ATLEAST_NOUGAT && prefs(context).backportAdaptiveIcons) {
                return true
            }
        ...
        fun getAppliedValue(context: Context): ShapeInfo {
            ...
            if (!me.sparker0i.lawnchair.Utilities.ATLEAST_NOUGAT) return ShapeInfo("", "", 100, prefs.usePixelIcons)
            ...
            if (!me.sparker0i.lawnchair.Utilities.ATLEAST_OREO && TextUtils.isEmpty(iconShape))
        ...
        private fun prefs(context: Context): IPreferenceProvider {
            return me.sparker0i.lawnchair.Utilities.getPrefs(context)
        }
