...
object FeatureFlags {
    ...
    fun pullDownAction(context: Context): Int {
        me.sparker0i.lawnchair.Utilities.getPrefs(context).migratePullDownPref(context)
    ...
    fun applyDarkTheme(activity: Activity) {
        me.sparker0i.lawnchair.Utilities.getPrefs(activity).migrateThemePref(activity)
