package me.sparker0i.lawnchair.preferences
...
open class PreferenceImpl(context: Context) : IPreferenceProvider {
    ...
    override fun showSettings(launcher: me.sparker0i.lawnchair.Launcher, view: View) {
    ...
    override var extractedColorsPreference
            by MutableStringPref(PreferenceFlags.KEY_EXTRACTED_COLORS_PREFERENCE, me.sparker0i.lawnchair.dynamicui.ExtractedColors.VERSION.toString())
    ...
    override val backportAdaptiveIcons = me.sparker0i.lawnchair.Utilities.ATLEAST_NOUGAT
    ...
    private var sharedPrefs: SharedPreferences = context.applicationContext.getSharedPreferences(
            me.sparker0i.lawnchair.LauncherFiles.SHARED_PREFERENCES_KEY, Context.MODE_PRIVATE)
